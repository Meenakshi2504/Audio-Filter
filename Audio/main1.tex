...
\begin{align}
\mathcal{Z}\{x(n-k)\} &= \sum_{n=-\infty}^{\infty} x(n-1)z^{-n} \\
&= z^{-1}\sum_{n=-\infty}^{\infty} x(n)z^{-n}
\end{align}
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/2.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/fft.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/3.c
\end{lstlisting}
