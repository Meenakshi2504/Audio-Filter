...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11008 - Annapureddy Siva Meenakshi$^{*}$}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/singing.wav
\end{lstlisting}
\item A Python Code is written to achieve Audio Filtering
\lstinputlisting{/home/meena/Audio/codes/filter.py}
...
\begin{figure}[H]
    \includegraphics[width=0.8\columnwidth]{figs/before filtering.png}
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.8\columnwidth]{figs/after filtering.png}
...
The C code calculates $y(n)$ and generates values in a text file.
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/1.c
\end{lstlisting}
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/1.py
\end{lstlisting}
\begin{figure}[H]
    \centering
...
\solution The following code plots the magnitude of the transfer function.\\
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/2.py
\end{lstlisting}
...
Yes $h\brak{n}$ is convergent and bounded
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/3.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/h_n.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/4.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/6.py  
\end{lstlisting}
This code verifies the result by plotting the obtained result with the result obtained by IDFT.
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/yn_verf.png}
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/7.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/8.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	...
	&= \brak{1.29\times 10^{-5}}x(n) + \brak{5.74 \times 10^{-5}}x(n - 1) \nonumber \\
	&+ \brak{8.60 \times 10^{-5}}x(n - 2) + \brak{5.74 \times 10^{-5}}x(n - 3) \nonumber \\
	&+ \brak{1.29 \times 10^{-5}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/9.py
\end{lstlisting}
\input{tables/table}
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/analog_filter.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Meenakshi2504/Audio-Filter/blob/main/Audio/codes/pole_zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/pole_zero.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/h(n)_1.png}
